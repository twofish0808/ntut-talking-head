...
from tha.combiner import CombinerSpec, Combiner
from tha.face_morpher import FaceMorpherSpec, FaceMorpher
from tha.two_algo_face_rotator import TwoAlgoFaceRotatorSpec, TwoAlgoFaceRotator
...
if __name__ == "__main__":
    ...
    poser = MorphRotateCombinePoser256Param6(
        ...
        morph_module_file_name="./checkpoints/face_morpher/face_morpher.pt",
        rotate_module_spec=TwoAlgoFaceRotatorSpec(),
        rotate_module_file_name="./checkpoints/two_algo_face_rotator/two_algo_face_rotator.pt",
        combine_module_spec=CombinerSpec(),
        combine_module_file_name="./checkpoints/combiner/combiner.pt",
        device=cuda)
    root = Tk()
