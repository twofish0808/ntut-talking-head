...
while True:
    ...
    for epoch in range(n_epoch):
        ...
        for data, label, target, label2 in img_dataloader:
            ...
            color1 = unloader(color_cd1[0]).save("./train_file/color_changed.png")
            ...
            final_image1 = unloader(final_image1[0]).save("./train_file/final_image.png") 
            combined_image1 = combined_image.cuda().clone()
            combined_image1 = unloader(combined_image1[0]).save("./train_file/combined_image.png")  
            combine_alpha_mask1 = combine_alpha_mask.cuda().clone()
            combine_alpha_mask1 = unloader(combine_alpha_mask1[0]).save("./train_file/combine_alpha_mask.png")     
            retouch_alpha_mask1 = retouch_alpha_mask.cuda().clone()
            retouch_alpha_mask1 = unloader(retouch_alpha_mask1[0]).save("./train_file/alpha_mask.png")     
            retouch_color_change1 = retouch_color_change.cuda().clone()
            retouch_color_change1 = unloader(retouch_color_change1[0]).save("./train_file/alpha_mask.png")           
